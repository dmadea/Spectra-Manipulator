...
from PyQt5.QtWidgets import QColorDialog, QVBoxLayout
...
from spectramanipulator.settings.structure import style_settings
...
class StyleWidget(InputWidget):
    ...
    def __init__(self, dock_widget, accepted_func, selected_item, parent=None):
        ...
        self.root_cti = RootCti(self.settings, root_xpath='/')
