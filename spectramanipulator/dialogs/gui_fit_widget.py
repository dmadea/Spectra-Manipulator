...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 381, 214))
        ...
        self.horizontalLayout_9.addWidget(self.cbResWeighting)
        ...
        self.cbVarPro = QtWidgets.QCheckBox(Form)
        self.cbVarPro.setChecked(True)
        self.cbVarPro.setObjectName("cbVarPro")
        self.verticalLayout_3.addWidget(self.cbVarPro)
...
"bound"))
        ...
        self.cbVarPro.setText(_translate("Form", "Calculate amplitudes from data (=use Variable projection for fitting)"))
