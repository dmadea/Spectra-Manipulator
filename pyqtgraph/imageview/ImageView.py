...
class ImageView(QtGui.QWidget):
    ...
    * Basic analysis features including:
        ...
        * ROI and embedded pyqtgraph-modif for measuring image values across frames
    ...
    * space begins playing frames. If time values (in seconds) are given 
    ...
    def __init__(self, parent=None, name="ImageView", view=None, imageItem=None, 
        ...
        **Arguments** 
        ...
        self.roiClicked() ## initialize roi pyqtgraph-modif to correct shape / visibility
    ...
    def roiChanged(self):
        ...
        # Convert extracted data into 1D pyqtgraph-modif data
