...
def plot(*args, **kargs):
    ...
    (this is just a window with :class:`PlotWidget <pyqtgraph.PlotWidget>` inside), pyqtgraph-modif data in it.
    Accepts a *title* argument to set the title of the window.
    All other arguments are used to pyqtgraph-modif data. (see :func:`PlotItem.pyqtgraph-modif() <pyqtgraph.PlotItem.pyqtgraph-modif>`)
    """
    mkQApp()
    #if 'title' in kargs:
