...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.averageGroup.setToolTip(QtGui.QApplication.translate("Form", "Display averages of the curves displayed in this pyqtgraph-modif. The parameter list allows you to choose parameters to average over (if any are available).", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.maxTracesCheck.setToolTip(QtGui.QApplication.translate("Form", "If multiple curves are displayed in this pyqtgraph-modif, check this box to limit the number of traces that are displayed.", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.maxTracesSpin.setToolTip(QtGui.QApplication.translate("Form", "If multiple curves are displayed in this pyqtgraph-modif, check \"Max Traces\" and set this value to limit the number of traces that are displayed.", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.downsampleSpin.setToolTip(QtGui.QApplication.translate("Form", "Downsample data before plotting. (pyqtgraph-modif every Nth sample)", None, QtGui.QApplication.UnicodeUTF8))
