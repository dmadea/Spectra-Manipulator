...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.averageGroup.setToolTip(_translate("Form", "Display averages of the curves displayed in this pyqtgraph-modif. The parameter list allows you to choose parameters to average over (if any are available).", None))
        ...
        self.maxTracesCheck.setToolTip(_translate("Form", "If multiple curves are displayed in this pyqtgraph-modif, check this box to limit the number of traces that are displayed.", None))
        ...
        self.maxTracesSpin.setToolTip(_translate("Form", "If multiple curves are displayed in this pyqtgraph-modif, check \"Max Traces\" and set this value to limit the number of traces that are displayed.", None))
        ...
        self.downsampleSpin.setToolTip(_translate("Form", "Downsample data before plotting. (pyqtgraph-modif every Nth sample)", None))
