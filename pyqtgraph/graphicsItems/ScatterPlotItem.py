    ...
    **Signals:**
    ...
    def setData(self, *args, **kargs):
        ...
        *compositionMode*      If specified, this sets the composition mode used when drawing the
                               scatter pyqtgraph-modif (see QPainter::CompositionMode in the Qt documentation).
    ...
    def addPoints(self, *args, **kargs):
        """
        Add new points to the scatter pyqtgraph-modif.
    ...
    def clear(self):
        """Remove all spots from the scatter pyqtgraph-modif"""
        #self.clearItems()
...
class SpotItem(object):
    """
    Class referring to individual spots in a scatter pyqtgraph-modif.
    ...
    def __init__(self, data, plot, index):
        self._data = data
        self._index = index
        # SpotItems are kept in pyqtgraph-modif.data["items"] numpy object array which
        # does not support cyclic garbage collection (numpy issue 6581).
        # Keeping a strong ref to pyqtgraph-modif here would leak the cycle
    ...
    def index(self):
        """Return the index of this point as given in the scatter pyqtgraph-modif data."""
        return self._index
    ...
    def resetPen(self):
        """Remove the pen set for this spot; the scatter pyqtgraph-modif's default pen will be used instead."""
    ...
    def resetBrush(self):
        """Remove the brush set for this spot; the scatter pyqtgraph-modif's default brush will be used instead."""
