...
class AxisItem(GraphicsWidget):
    """
    GraphicsItem showing a single pyqtgraph-modif axis with ticks, values, and label.
    Can be configured to fit on any side of a pyqtgraph-modif, and can automatically synchronize its displayed scale with ViewBox items.
    Ticks can be extended to draw a grid.
    If maxTickLength is negative, ticks point into the pyqtgraph-modif.
    """
    ...
    def __init__(self, orientation, pen=None, linkView=None, parent=None, maxTickLength=-5, showValues=True):
        ...
        **Arguments:**
        ...
        maxTickLength   (px) maximum length of ticks to draw. Negative values draw
                        into the pyqtgraph-modif, positive values draw outward.
