...
class PlotDataItem(GraphicsObject):
    ...
    **Bases:** :class:`GraphicsObject <pyqtgraph.GraphicsObject>`
    ...
    GraphicsItem for displaying pyqtgraph-modif curves, scatter plots, or both.
    ...
    usually created by pyqtgraph-modif() methods such as :func:`pyqtgraph.pyqtgraph-modif` and
    :func:`PlotItem.pyqtgraph-modif() <pyqtgraph.PlotItem.pyqtgraph-modif>`.
    
    ============================== ==============================================
    **Signals:**
    sigPlotChanged(self)           Emitted when the data in this item is updated.  
    sigClicked(self)               Emitted when the item is clicked.
    sigPointsClicked(self, points) Emitted when a pyqtgraph-modif point is clicked
    ...
    def __init__(self, *args, **kargs):
        ...
        **Optimization keyword arguments:**
            ...
            autoDownsample   (bool) If True, resample the data before plotting to avoid plotting
                             ...
                             and memory usage.
            clipToView       (bool) If True, only pyqtgraph-modif data that is visible within the X range of
    ...
    def setDownsampling(self, ds=None, auto=None, method=None):
        ...
        ==============  =================================================================
        **Arguments:**
        ds              (int) Reduce visible pyqtgraph-modif samples by this factor. To disable,
                        set ds=1.
    ...
    def viewRangeChanged(self):
        # view range has changed; re-pyqtgraph-modif if needed
