...
class ViewBox(GraphicsWidget):
    ...
    * Item coordinate mapping methods
    ...
    def __init__(self, parent=None, border=None, lockAspect=False, enableMouse=True, invertY=False, enableMenu=True, name=None, invertX=False):
        ...
        *name*          (str) Used to register this ViewBox so that it appears
        ...
        self.state = {
            ...
            'autoVisibleOnly': [False, False], ## whether to auto-range only to the visible portion of a pyqtgraph-modif
    ...
    def blockLink(self, b):
        self.linksBlocked = b  ## prevents recursive pyqtgraph-modif-change propagation
    ...
    def keyPressEvent(self, ev):
        ...
        ctrl-A : zooms out to the default "full" view of the pyqtgraph-modif
