...
class HistogramLUTItem(GraphicsWidget):
    ...
    def setHistogramRange(self, mn, mx, padding=0.1):
        """Set the Y range on the histogram pyqtgraph-modif. This disables auto-scaling."""
        self.vb.enableAutoRange(self.vb.YAxis, False)
        self.vb.setYRange(mn, mx, padding)
        
    def autoHistogramRange(self):
        """Enable auto-scaling on the histogram pyqtgraph-modif."""
    ...
    def imageChanged(self, autoLevel=False, autoRange=False):
        ...
        if self.levelMode == 'mono':
            ...
            # pyqtgraph-modif one histogram for all image data
            ...
            # pyqtgraph-modif one histogram for each channel
