...
class LocalObjectProxy(object):
    ...
    For example::
        ...
        data = [1,2,3,4,5]
        remotePlot.pyqtgraph-modif(data)         ## by default, lists are pickled and sent by value
        remotePlot.pyqtgraph-modif(proxy(data))  ## force the object to be sent by proxy
